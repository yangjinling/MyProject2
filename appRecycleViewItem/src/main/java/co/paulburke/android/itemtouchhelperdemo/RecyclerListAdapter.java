...
public class RecyclerListAdapter extends RecyclerView.Adapter<RecyclerListAdapter.ItemViewHolder>
        implements ItemTouchHelperAdapter, View.OnClickListener, View.OnLongClickListener {
    @Override
    public void onClick(View v) {
        if (mOnRecycleItemClickListener != null) {
            mOnRecycleItemClickListener.onItemClick(v, (Integer) v.getTag());
        }
    }
    ...
    public boolean onLongClick(View v) {
        mOnRecycleItemClickListener.onItemLongClick(v, (Integer) v.getTag());
        return false;
    }
